...
import com.spasi.android.controller.button.ButtonActivity;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnButtonExperimental = (Button)findViewById(R.id.btnExperimental);
        btnButtonExperimental.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getBaseContext(),ButtonActivity.class);
                startActivity(i);
            }
        });
    }
