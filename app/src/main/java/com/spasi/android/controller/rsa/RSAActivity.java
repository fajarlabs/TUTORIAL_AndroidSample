package com.spasi.android.controller.rsa;
...
public class RSAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView editTextPrivateKey = (TextView) findViewById(R.id.editTextPrivateKey);
        final TextView editTextCipher = (TextView) findViewById(R.id.editTextCipher);
        btnRSAEncrypt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    Map result = RSASecurity.encode("HELLO WORLD");
                    String b64PrivateKey = (String) result.get("privateKeyBase64");
                    editTextPrivateKey.setText(b64PrivateKey);
                    String b64EncryptedStr = (String) result.get("cipherText");
                    editTextCipher.setText(b64EncryptedStr);
...
//                    System.out.println(result);
        ...
        final TextView editTextDecode = (TextView) findViewById(R.id.editTextDecoded);
        btnRSADecrypt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextDecode.setText(RSASecurity.decode(editTextCipher.getText().toString(),editTextPrivateKey.getText().toString()));
            }
        });

        Button btnClearRSA = (Button) findViewById(R.id.btnClearRSA);
        btnClearRSA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextPrivateKey.setText("");
                editTextDecode.setText("");
                editTextCipher.setText("");
            }
        });
